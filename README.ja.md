...
手漕ぎボートで油壷の海に浮かんだときに採取した水深データです。
...
2025-11-13 17:52:13,988 - INFO - 結果を /home/iida/git/aburatsubo-terrain-data/static/data/coastline.csv に保存しました。
2025-11-13 17:52:14,622 - INFO - 可視化結果を /home/iida/git/aburatsubo-terrain-data/img/coastline.png に保存しました。
```
...
これら点を水深0mとして追加することで、地図とぴったりくっつくようになります。
