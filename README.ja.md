...
密度が薄いところは3Dでメッシュ化するためにデータ数を増やします。
...
## 現在のベストプラクティス（2026年02月時点）

process_desity_reduce.py を使って高密度な点を集約

process_uniform_random_fill.py を使って疎な領域の点を補完
